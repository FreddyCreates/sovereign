...
class PocketIcServer {
    ...
    static async start(options = {}) {
        ...
        const serverProcess = (0, node_child_process_1.spawn)(binPath, ['--pid', pid.toString(), '--ttl', options.ttl ? options.ttl.toString() : '60']);
    ...
    async stop() {
        return new Promise((resolve, reject) => {
            ...
            (0, node_fs_1.rmSync)((0, util_1.tmpFile)(`${picFilePrefix}.port`), { force: true });
            (0, node_fs_1.rmSync)((0, util_1.tmpFile)(`${picFilePrefix}.ready`), { force: true });
        });
    }
    static getBinPath() {
