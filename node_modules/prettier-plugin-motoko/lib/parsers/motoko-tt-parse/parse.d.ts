...
export default function parse(text: string, options: ParserOptions<TokenTree>): TokenTree;
export default function parse(text: string, parsers: object, options: ParserOptions<TokenTree>): TokenTree;
export {};
