...
const removeZeroWidthCharacters_1 = __importDefault(require("../../utils/removeZeroWidthCharacters"));
...
function preprocess(code, options) {
    ...
    code = (0, removeZeroWidthCharacters_1.default)(code); // remove invisible unicode characters
    if (options.semi) {
        // Infer semicolons
